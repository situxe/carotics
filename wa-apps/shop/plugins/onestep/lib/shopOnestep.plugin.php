...
class shopOnestepPlugin extends shopPlugin {
    ...
    public static $templates = array(
        'onestepCart' => array(
            'name' => 'Главный шаблон. Корзина',
            'tpl_path' => 'plugins/onestep/templates/',
            'tpl_name' => 'onestepCart',
            'tpl_ext' => 'html',
            'public' => false,
        ),
        'onestep' => array(
            'name' => 'Главный шаблон. Оформление заказа',
            'tpl_path' => 'plugins/onestep/templates/',
            'tpl_name' => 'onestep',
            'tpl_ext' => 'html',
            'public' => false,
    ...
    public function frontendHead($param) {
        ...
        if (
            ...
            if (wa()->getRouting()->getCurrentUrl() == 'cart/') {
                $onestep_url = wa()->getRouteUrl('shop/frontend/onestepCart');
            } else {
    ...
    public function routing($route = array()) {
        ...
        return array(
            $page_url . 'cart/' => 'frontend/onestepCart',
